...
//    [infoCenter setNowPlayingInfo:@{MPMediaItemPropertyTitle:@"PPTV",
//                                    MPMediaItemPropertyArtist:@"PPTV"}];

    
    self.player = [AVPlayer playerWithURL:[NSURL URLWithString:@"https://kexp-mp3-128.streamguys1.com/kexp128.mp3"]];
...
//    playingInfo[MPMediaItemPropertyAlbumTitle] = @"PPTV";
//    playingInfo[MPMediaItemPropertyArtist] = @"PPTV";
//    playingInfo[MPMediaItemPropertyTitle] = @"PPTV";
//
...
//    [[AVAudioSession sharedInstance] setCategory:AVAudioSessionCategoryPlayAndRecord withOptions:nil error:nil];
